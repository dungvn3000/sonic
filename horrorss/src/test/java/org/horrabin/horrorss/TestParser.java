...
public class TestParser extends TestCase {
	...
	public void testSimpleGeoModuleParser(){
		RssParser rss = new RssParser("horrorss/src/test/resources/data/georss.xml");
	...
	public void testCache(){
		...
		rss.enableCache("horrorss/src/test/resources/data/", 1000);
		
		File file = new File("horrorss/src/test/resources/data/https%3A%2F%2Fhorrorss.googlecode.com%2Fsvn%2Ftrunk%2Fsrc%2Ftest%2Fdata%2Frss-utf8.xml.cache");
		assertEquals(false, file.exists());
		
		try {
			rss.load("https://horrorss.googlecode.com/svn/trunk/src/resources/data/rss-utf8.xml");
	...
	public void testUTF8FileParse(){
		this.fileParse("horrorss/src/test/resources/data/rss-utf8.xml", "utf-8");
	...
	public void testUTF8URLParse(){
		this.fileParse("https://horrorss.googlecode.com/svn/trunk/src/resources/data/rss-utf8.xml", "utf-8");
		assertEquals(21,this.items.size());
	...
	public void testISO88591FileParse(){
		this.fileParse("horrorss/src/test/resources/data/rss-iso-8859-1.xml", "iso-8859-1");
		assertEquals(21,this.items.size());
	...
	public void testISO88591URLParse(){
		this.fileParse("http://horrorss.googlecode.com/svn/trunk/src/resources/data/rss-iso-8859-1.xml", "iso-8859-1");
		assertEquals(21,this.items.size());
	...
	public void testAtomParse(){
		this.fileParse("horrorss/src/test/resources/data/rss-atom.xml");
		assertEquals(21,this.items.size());
	...
	public void testRSSParse(){
		this.fileParse("horrorss/src/test/resources/data/rss20.xml");
	...
	public void testRDFParse(){
		this.fileParse("horrorss/src/test/resources/data/rss-rdf.xml");
	...
	public void testFileParse(){
		this.fileParse("horrorss/src/test/resources/data/rss-utf8.xml");
		assertEquals(21,this.items.size());
	...
	public void testURLParse(){
		this.fileParse("http://horrorss.googlecode.com/svn/trunk/src/resources/data/rss-utf8.xml");
